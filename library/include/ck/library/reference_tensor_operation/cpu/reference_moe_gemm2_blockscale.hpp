...
struct ReferenceMoeGemm2BlockScale : public device::BaseOperator
{
    ...
    struct Argument : public device::BaseArgument
    {
        Argument(const Tensor<ck::index_t>& sorted_token_ids,
                 ...
                 const Tensor<AsDataType>& as_t_k_k,
                 const Tensor<BsDataType>& bs_e_n_k,
            ...
            : sorted_token_ids_{sorted_token_ids},
              ...
              bs_e_n_k_{bs_e_n_k},
              d2_{d2},
              scale_block_m_{scale_block_m},
              scale_block_n_{scale_block_n},
              scale_block_k_{scale_block_k},
              c_t_n_{c_t_n},
        ...
        const Tensor<AsDataType>& as_t_k_k_;
        const Tensor<BsDataType>& bs_e_n_k_;
        const Tensor<D2DataType>& d2_;
        const index_t scale_block_m_;
        const index_t scale_block_n_;
        const index_t scale_block_k_;
            ...
            auto f_mk_kn_mn = [&](auto m, auto n) {
                ...
                if(t < token_cnt)
                {
                    for(int k = 0; k < K; ++k)
                    {
                        ...
                        v_as = arg.as_t_k_k_(t / arg.scale_block_m_, topk_id, k / arg.scale_block_k_);
                        v_bs = arg.bs_e_n_k_(e, k / arg.scale_block_k_, n / arg.scale_block_n_);
                        v_acc +=
                            ck::type_convert<AccDataType>(v_a) * ck::type_convert<AccDataType>(v_as) * ck::type_convert<AccDataType>(v_b) * ck::type_convert<AccDataType>(v_bs);
                    }
                    CDataType v_c{0};
                    arg.c_element_op_(v_c, v_acc);
                    arg.c_t_n_(t, n) += ck::type_convert<AccDataType>(v_c) * ck::type_convert<AccDataType>(v_topk_w);
                }
            };
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "ReferenceMoeGemm2BlockScale"
            << std::endl;
        // clang-format on
