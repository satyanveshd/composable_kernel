...
struct DeviceMoeGemm_BlockScale
                                                        ...
                                                        CElementwiseOperation>
{
    ...
    using GridwiseGemm                  = GridwiseMoeGemm_BlockScale<
                         ALayout,
                         BLayout,
                         DsLayout,
                         CLayout,
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            if(has_main_k_block_loop)
            {
                ...
                {
                    {
                        ...
                        {
                            const auto kernel = kernel_moe_gemm_blockscale<GridwiseGemm,
                                                                true,
                                                                MemoryDataOp,
                                                                minimum_occupancy,
                                                                TailNumber::Odd>;
                                  ...
                                  BlkGemmPipelineVer == BlockGemmPipelineVersion::v3)
                {
                    if(GridwiseGemm::CalculateKBlockLoopTailNum(K_split) == TailNumber::Odd)
                    {
                        const auto kernel = kernel_moe_gemm_blockscale_2lds<GridwiseGemm,
                                                                 true,
                                                                 MemoryDataOp,
                                                                 minimum_occupancy,
                                                                 TailNumber::Odd>;
