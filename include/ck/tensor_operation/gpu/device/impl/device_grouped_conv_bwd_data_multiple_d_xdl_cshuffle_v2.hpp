...
#endif
        kernel_grouped_conv_bwd_data_multiple_d_xdl_cshuffle_v2(
...
struct DeviceGroupedConvBwdDataMultipleD_Xdl_CShuffle_v2
                                               ...
                                               BComputeType>
{
    ...
    using DeviceOp = DeviceGroupedConvBwdDataMultipleD_Xdl_CShuffle_v2;
    ...
    static constexpr ConvolutionForwardSpecialization FwdSpecCasted = ConvBackwardDataSpecialization == ConvolutionBackwardDataSpecialization::Default ? ConvolutionForwardSpecialization::Default : ConvolutionForwardSpecialization::Filter1x1Stride1Pad0;

    using ConvToGemmBwdDataTransformV2 = TransformConvFwdToGemm<NDimSpatial,
                                                            FwdSpecCasted,
                                                            true /*SplitN*/,
                                                            ABDataType,
                                                            EDataType,
    ...
    // TransformConvBwdDataToGemm_v2<NDimSpatial,
    ...
    static auto MakeAGridDescriptor_M_K(const ConvToGemmBwdDataTransformV2& conv_to_gemm_transformer)
    {
        namespace ctc = tensor_layout::convolution;
        using Layout  = std::conditional_t<
            is_NGCHW_NGKHW<ELayout, BLayout, ALayout>(),
            ctc::NHWGC,
            std::conditional_t<is_NGCDHW_NGKDHW<ELayout, BLayout, ALayout>(), ctc::NDHWGC, ALay>>;
    ...
    static auto MakeBGridDescriptor_N_K(const ConvToGemmBwdDataTransformV2& conv_to_gemm_transformer)
    {
        namespace ctc = tensor_layout::convolution;
        using Layout  = std::conditional_t<
            is_NGCHW_NGKHW<ELayout, BLayout, ALayout>(),
            ctc::GKYXC,
            std::conditional_t<is_NGCDHW_NGKDHW<ELayout, BLayout, ALayout>(), ctc::GKZYXC, BLay>>;
    ...
    static auto MakeEGridDescriptor_M_N(const ConvToGemmBwdDataTransformV2& conv_to_gemm_transformer)
    {
        namespace ctc = tensor_layout::convolution;
        using Layout  = std::conditional_t<
            is_NGCHW_NGKHW<ELayout, BLayout, ALayout>(),
            ctc::NHWGK,
            std::conditional_t<is_NGCDHW_NGKDHW<ELayout, BLayout, ALayout>(), ctc::NDHWGK, ELay>>;
    ...
    // static auto
    // GetDummyABDsEGridDescriptor(const ConvToGemmBwdDataTransformV2& conv_to_gemm_transform)
    // {
...
#define GridwiseGemmMultiDTemplateParams                                                        \
    ...
    // desc
    // constexpr static ConvToGemmBwdDataTransformV2 dummy_conv_to_gemm_transform;
    ...
    constexpr static ConvToGemmBwdDataTransformV2 dummy_conv_to_gemm_transformer;
    using AGridDesc_M_K =
        remove_cvref_t<decltype(MakeEGridDescriptor_M_N<ALayout>(dummy_conv_to_gemm_transformer))>;
    using BGridDesc_N_K =
        remove_cvref_t<decltype(MakeBGridDescriptor_N_K<BLayout>(dummy_conv_to_gemm_transformer))>;
    using EGridDesc_M_N =
        remove_cvref_t<decltype(MakeAGridDescriptor_M_K<ELayout>(dummy_conv_to_gemm_transformer))>;
              ...
              k_batch_{split_k}
        {
            ...
            std::array<index_t, NDimSpatial + 3> e_g_n_c_wis_strides_transposed =
                conv_ngchw_to_nhwgc_transformer.TransposeInOutStrides(e_g_n_c_wis_lengths,
                        ...
                        ConvToGemmBwdDataTransformV2 conv_to_gemm_transform_{e_g_n_c_wis_lengths,
                                        e_g_n_c_wis_strides,
                                        b_g_k_c_xs_lengths,
                                        b_g_k_c_xs_strides,
                                        a_g_n_k_wos_lengths,
                        ...
                        const auto a_grid_desc_m_k = DeviceOp::MakeEGridDescriptor_M_N<ALayout>(conv_to_gemm_transform_);
                        const auto b_grid_desc_n_k = DeviceOp::MakeBGridDescriptor_N_K<BLayout>(conv_to_gemm_transform_);
                        const auto e_grid_desc_m_n = DeviceOp::MakeAGridDescriptor_M_K<ELayout>(conv_to_gemm_transform_);
                        
                        const auto a_grid_desc_ak0_m_ak1 = GridwiseGemm::MakeDefaultAGridDescriptor_AK0_M_AK1(a_grid_desc_m_k);

                        const auto b_grid_desc_bk0_n_bk1 = GridwiseGemm::MakeDefaultBGridDescriptor_BK0_N_BK1(b_grid_desc_n_k);
    ...
    struct Invoker : public BaseInvoker
    {
        ...
        float RunMultiDGemm(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            // {
                if(!GridwiseGemm::CheckValidity(arg.a_grid_desc_m_k_container_[0],
                                                arg.b_grid_desc_n_k_container_[0],
                                                make_tuple(),
                                                arg.e_grid_desc_m_n_container_[0],
                                                arg.block_2_etile_map_container_[0],
                                                arg.k_batch_))
                {
                    throw std::runtime_error("wrong! device_op has invalid setting");
                }

                const index_t gdx = arg.block_2_etile_map_container_[0].CalculateGridSize(
                    arg.e_grid_desc_m_n_container_[0]);

                const auto GemmK = arg.a_grid_desc_m_k_container_[0].GetLength(I1);
                ...
                auto launch_kernel = [&](auto has_main_k_block_loop) {
                    ...
                    const auto kernel = kernel_grouped_conv_bwd_data_multiple_d_xdl_cshuffle_v2<
                        GridwiseGemm,
                    ...
                    return launch_and_time_kernel(
                        ...
                        arg.b_element_op_,
                        arg.cde_element_op_,
                        arg.a_grid_desc_ak0_m_ak1_container_[0],
                        arg.b_grid_desc_bk0_n_bk1_container_[0],
                        make_tuple(),
                        arg.e_grid_desc_mblock_mperblock_nblock_nperblock_container_[0],
                        arg.block_2_etile_map_container_[0],
                ...
                if(ck::EnvIsEnabled(CK_ENV(CK_LOGGING)))
                {
                    std::cout
                        << "Warning: Workspace for "
                           "DeviceGroupedConvBwdDataMultipleD_Xdl_CShuffle_v2::Argument is not "
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceGroupedConvBwdDataMultipleD_Xdl_CShuffle_v2"
            << "<"
            << BlockSize << ", "
            << MPerBlock << ", "
            << NPerBlock << ", "
    ...
    size_t GetWorkSpaceSize(const BaseArgument* p_arg) const override
    {
        ...
        if(arg)
        {
            ...
            throw std::runtime_error(
                ...
                "DeviceGroupedConvBwdDataMultipleD_Xdl_CShuffle_v2::Argument structure!");
    }
